...
Nesef alan arada nefes vermeyi unutsam keşke diyen bir Fuwk4n.
                </p>
              </div>
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="x" src={`https://cdn.discordapp.com/avatars/691729067636031538/3d7584c80dfe767a07724d1549d36378.webp?size=1024`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
            ...
            ? repositories
              ? repositories
                  ...
                  .map((_, __) => (
                    <a
                      key={__}
                      href={`https://github.com/fuwk4n/`+_.name}
                      target="_blank"
                      rel="noreferrer"
