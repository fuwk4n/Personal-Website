...
Nesef alan arada nefes vermeyi unutsam keşke diyen bir Fuwk4n.
              ...
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="x" src={`https://cdn.discordapp.com/icons/1112481570935283842/a_80f43323ad33a6053557b84ea7a14997.gif?size=512`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
